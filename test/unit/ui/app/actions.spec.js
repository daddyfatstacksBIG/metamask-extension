...
describe("Actions", () => {
  ...
  describe("#tryUnlockMetamask", () => {
    ...
    it("calls submitPassword and verifySeedPhrase", async () => {
      ...
      return store.dispatch(actions.tryUnlockMetamask()).then(() => {
  ...
  describe("#requestRevealSeedWords", () => {
    ...
    it("calls submitPassword in background", () => {
      ...
      return store.dispatch(actions.requestRevealSeedWords()).then(() => {
        assert(submitPasswordSpy.calledOnce);
      });
    });
  ...
  describe("#resetAccount", () => {
    ...
    it("resets account", async () => {
      ...
      return store.dispatch(actions.resetAccount()).then(() => {
  ...
  describe("#importNewAccount", () => {
    ...
    it("calls importAccountWithStrategies in background", () => {
      ...
      return store
        .dispatch(actions.importNewAccount("Private Key", [importPrivkey]))
        .then(() => {
  ...
  describe("#addNewAccount", () => {
    ...
    it("Adds a new account", () => {
      ...
      return store.dispatch(actions.addNewAccount()).then(() => {
  ...
  describe("#signMsg", () => {
    ...
    it("calls signMsg in background", () => {
      ...
      return store.dispatch(actions.signMsg(msgParams)).then(() => {
  ...
  describe("#signPersonalMsg", () => {
    ...
    it("calls signPersonalMessage", () => {
      ...
      return store.dispatch(actions.signPersonalMsg(msgParams)).then(() => {
  ...
  describe("#lockMetamask", () => {
    ...
    it("calls setLocked", () => {
      ...
      return store.dispatch(actions.lockMetamask()).then(() => {
  ...
  describe("#addToken", () => {
    ...
    it("calls addToken in background", () => {
      ...
      store.dispatch(actions.addToken()).then(() => {
  ...
  describe("#removeToken", () => {
    ...
    it("calls removeToken in background", () => {
      const store = mockStore();
      store.dispatch(actions.removeToken()).then(() => {
  ...
  describe("#updateNetworkNonce", () => {
    ...
    it("calls getTransactionCount", () => {
      const store = mockStore();
      getTransactionCountSpy = sinon.spy(
        global.ethQuery,
        "getTransactionCount"
      );

      store.dispatch(actions.updateNetworkNonce()).then(() => {
  ...
  describe("#updateCurrentLocale", () => {
    ...
    it("calls expected actions", () => {
      ...
      return store.dispatch(actions.updateCurrentLocale("en")).then(() => {
  ...
  describe("#markPasswordForgotten", () => {
    ...
    beforeEach(() => {
      markPasswordForgottenSpy = sinon.stub(
        background,
  ...
  describe("#unMarkPasswordForgotten", () => {
    ...
    beforeEach(() => {
      unMarkPasswordForgottenSpy = sinon.stub(
        background,
