...
describe("MetaMask", function() {
  ...
  describe("Going through the first time flow", () => {
    ...
    it("reveals the seed phrase", async () => {
      ...
      const nextScreen = (await findElements(
        driver,
  ...
  describe("Send ETH from inside MetaMask using default gas", () => {
    ...
    it("finds the transaction in the transactions list", async function() {
      const transactions = await findElements(
        driver,
      ...
      if (process.env.SELENIUM_BROWSER !== "firefox") {
        ...
        await driver.wait(
          until.elementTextMatches(txValues, /-1\s*ETH/),
          10000
        );
      }
    });
  ...
  describe("Deploy contract and call contract methods", () => {
    ...
    it("calls and confirms a contract method where ETH is sent", async () => {
      ...
      const [gasPriceInput, gasLimitInput] = await findElements(
        driver,
        By.css(".advanced-tab__gas-edit-row__input")
      );
  ...
  describe("Approves a custom token from dapp", () => {
    ...
    it("shows the correct recipient", async function() {
      const senderToRecipientDivs = await findElements(
        driver,
        By.css(".sender-to-recipient__name")
      );
