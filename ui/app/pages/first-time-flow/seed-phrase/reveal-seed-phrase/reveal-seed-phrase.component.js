...
export default class RevealSeedPhrase extends PureComponent {
  ...
  handleSkip =
      event => {
        event.preventDefault()
        const {history, setSeedPhraseBackedUp, setCompletedOnboarding} =
            this.props
  ...
  render () {
    ...
    return (
      ...
      <div className = "first-time-flow__text-block">{t('storePhrase')}<
          /div>
            <div className="first-time-flow__text-block">
              { t('writePhrase') }
            </div>
      <div className = "first-time-flow__text-block">{t('memorizePhrase')}<
          /div>
            <div className="first-time-flow__text-block">
              <a
  ...
  type = "primary"
  className = "first-time-flow__button"
  onClick = {this.handleNext} disabled = {!isShowingSeedPhrase} >
                                         {t('next')}</Button>
        </div><
                                         /div>
    )
